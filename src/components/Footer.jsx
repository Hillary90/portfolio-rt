    ...
    <footer className="bg-gray-900 dark:bg-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* About */}
          <div>
            <h3 className="text-2xl font-bold text-blue-400 mb-4">Hillary Tanui</h3>
            <p className="text-gray-400">
              Full-Stack Developer passionate about creating innovative solutions through code.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="mailto:hillarytanui80@gmail.com"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} Hillary Tanui. All rights reserved.
            </p>
